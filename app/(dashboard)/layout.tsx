  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="flex flex-1">
        <aside className="hidden w-64 border-r border-border bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl md:block">
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8 bg-slate-50/30 dark:bg-slate-950/30">
          {children}
        </main>
      </div>
    </div>
